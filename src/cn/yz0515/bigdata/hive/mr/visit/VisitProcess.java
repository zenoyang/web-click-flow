...
* @version 1.0  
*/
package cn.yz0515.bigdata.hive.mr.visit;
...
import cn.yz0515.bigdata.hive.mr.bean.VisitBean;
...
public class VisitProcess {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //测试
        FileInputFormat.setInputPaths(job, new Path("hdfs://192.168.1.100/web_click_project/pv_output"));
        FileOutputFormat.setOutputPath(job, new Path("hdfs://192.168.1.100/web_click_project/visit_output"));
