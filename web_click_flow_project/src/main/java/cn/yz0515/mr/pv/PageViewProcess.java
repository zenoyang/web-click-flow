...
public class PageViewProcess {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //测试
        /*FileInputFormat.setInputPaths(job, new Path("file:///home/yz/桌面/Hive-WebLogProcess/GenerateApacheLog/preoutput"));
        FileOutputFormat.setOutputPath(job, new Path("file:///home/yz/桌面/Hive-WebLogProcess/GenerateApacheLog/pvoutput"));*/
