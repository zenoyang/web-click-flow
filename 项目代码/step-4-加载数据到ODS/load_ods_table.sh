...
#目标hive表
ods_weblog_origin="web_click_project.ods_weblog_origin"
ods_click_pageviews="web_click_project.ods_click_pageviews"
ods_click_visit="web_click_project.ods_click_visit"

#导入raw数据到web_click_project.ods_weblog_origin
