...
# 功能描述:     抽取明细宽表
# 输入参数:     运行日期
# 目标表名:     web_click_project.ods_weblog_detail
# 数据源表:     web_click_project.ods_weblog_origin
#   创建人:     ZenoYang
# 创建日期:     2018-03-21
# 版本说明:     v1.0
# 代码审核:     
...
TARGET_DB=web_click_project
TARGET_TABLE=ods_weblog_detail

### 2.定义执行HQL
HQL="
insert into table web_click_project.ods_weblog_detail partition(datestr='$day_01')
...
FROM web_click_project.ods_weblog_origin a 
LATERAL VIEW 
